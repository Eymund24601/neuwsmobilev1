      ...
      child: ListView(
        ...
        children: [
          ...
          GridView.count(
            ...
            children: const [
              _PuzzleTile(title: 'Word wheel', accent: Color(0xFFEFA1A1), icon: Icons.blur_circular),
              _PuzzleTile(title: 'Wordiply', accent: Color(0xFFD6A3FF), icon: Icons.grid_3x3),
              _PuzzleTile(title: 'On the ball', accent: Color(0xFF9FE0D1), icon: Icons.sports_soccer),
              _PuzzleTile(title: 'Film reveal', accent: Color(0xFFF5C36B), icon: Icons.movie_filter),
            ],
          ),
          const SizedBox(height: 16),
          Container(
